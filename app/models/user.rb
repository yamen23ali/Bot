...
class User < ActiveRecord::Base
    ...
    def self.send_welcome_message(messenger_id)
    	message = 'السلام عليكم :) مرحبا بك في أول تطبيق إسلامي من نوعه على الفيسبوك سنقوم بإرسال آيات و أحاديث شريفة يوميا إليك .. نرجو لك الفائدة و الأجر ، هذا التطبيق يرسل الرسائل بشكل تلقائي و لا حاجة للتفاعل معه'
